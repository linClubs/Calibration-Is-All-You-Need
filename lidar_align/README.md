...
+ 直接源码编译nlopt， 并修改lidar_align/CMakeLists.txt中语句
~~~python
# 将find_package(NLOPT REQUIRED) 修改为
find_package(NLopt REQUIRED)
~~~

+ 修改后，可以不安装libnlopt-dev等操作,直接编译lidar_align功能包
---
...
在lidar_align工程目录下，并在CMakeLists.txt里加上这样一句话：
...
+ 运行前需要修改`lidar_align.launch`中的参数
